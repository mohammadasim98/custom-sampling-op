...
ops_so = load_library.load_op_library(resource_loader.get_path_to_datafile('_ball_query_ops.so'))
...
def query_ball_point(radius, nsample, xyz1, xyz2):
    ...
    return ops_so.query_ball_point(xyz1, xyz2, radius, nsample, float)
